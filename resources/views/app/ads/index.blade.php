...
<div class="card">
    ...
    <div class="table-responsive">
        <table class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                <tr>
                    <th class="text-left">@lang('crud.ads.inputs.title')</th>
                    <th class="text-left">@lang('crud.ads.inputs.body')</th>
                    <th class="text-left">@lang('crud.ads.inputs.offer')</th>
                    <th class="text-left">@lang('crud.ads.inputs.image')</th>
                    <th class="text-left">
                        @lang('crud.ads.inputs.product_id')
                    </th>
